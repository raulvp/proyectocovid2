...
<div class="wrapper">
          ...
          <!-- Add icons to the links using the .nav-icon class
              ...
              <li class="nav-item">
                ...
                <ul class="nav nav-treeview">
                  ...
                  <li class="nav-item">
                    <a href="listas.html" class="nav-link">
                      <i class="far fa-circle nav-icon"></i>
                      <p>Editar</p>
                    </a>
                  </li>
            ...
            <div class="card card-primary">
              ...
              <form>
                  ...
                  <div class="row">
                      ...
                      <div class="form-group">
                        <label>Fecha Nacimiento:</label>
                          <div class="input-group date" id="reservationdate" data-target-input="nearest">
                              <input type="text" id="fechaNac" class="form-control datetimepicker-input" data-target="#reservationdate"/>
                    ...
                    <div class="col-4">
                      <div class="form-group">
                        ...
                        <select id="servicioSalud" class="form-control select2" style="width: 100%;">
                  ...
                  <div class="row">
                    ...
                    <div class="col-4">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="estsalud" placeholder="Establecimiento de Salud">
                      </div>
                    </div>
                    <div class="col-4">
                      <div class="form-group">
                        <label>Fecha Vacunacion:</label>
                          <div class="input-group date" data-target-input="nearest">
                              <input type="text" id="fechavacunacion" class="form-control datetimepicker-input" data-target="#fechavacunacion"/>
                  ...
                  <div class="row">
                    ...
                    <div class="col-4">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="proxvacuna" id="proxvacuna" placeholder="Proxima fecha de vacunacion">
                ...
                <div class="card-footer">
                  <button type="button" onClick="registrarVacuna()" class="btn btn-primary">Registrar</button>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2021 <a href="#">INCOS NOCTURNO</a>.</strong> Todos los derechos reservados.
  </footer>
